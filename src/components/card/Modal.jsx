...
const Modal = ({ modal, projects }) => {
  ...
  return (
    <>
      ...
      <motion.div
        ref={cursor}
        className='w-[80px] h-[80px] rounded-full bg-[#101010] text-[#dcd0c2] fixed flex items-center justify-center text-base 2xl:text-lg font-normal 2xl:font-medium pointer-events-none z-[60]'
        variants={scaleAnimation}
        initial="initial"
        animate={active ? 'open' : 'closed'}
      >
      ...
      <motion.div
        ref={cursorLabel}
        className='w-[80px] h-[80px] rounded-full bg-transparent text-[#dcd0c2] fixed flex items-center justify-center text-base 2xl:text-lg font-normal 2xl:font-medium pointer-events-none z-[61]'
        variants={scaleAnimation}
        initial="initial"
        animate={active ? 'open' : 'closed'}
      >
