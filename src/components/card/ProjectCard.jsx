...
const ProjectCard = ({
  ...
  lg:border-gray-300 mb-24 sm:mb-20 md:mb-28 lg:mb-0'
      ...
      <a
        ...
        className='w-full h-full lg:py-[40px] group'>
        <div
          className='lg:hidden w-[88vw] h-[86vw] sm:w-[43vw] sm:h-[43vw] flex items-center justify-center
    ...
    lg:group-hover:opacity-40 lg:group-hover:translate-x-2'>
        ...
        m-0 transition-all duration-500 ease-out'>
          ...
          <p
            className='hidden lg:block text-[18px] lg:text-[16px] lg:pr-[60px] xl:pr-[100px] font-light lg:font-normal
        m-0 transition-all duration-500 ease-out'>
            {desc}
          </p>
        </div>
