...
export const ImageProvider = ({ children }) => {
  ...
  // useEffect(() => {
  //   const socket = new WebSocket("wss://your-rails-server.com/cable");
  ...
  //       if (data.type === "SIGNED_URLS_UPDATE") {
  //         updateImageUrl(data.key, data.urls)
  //         // setImages(data.urls);
  //       }
  //     } catch (error) {
  ...
  //     setTimeout(() => new WebSocket("wss://your-rails-server.com/cable"), 5000);
  //   };
